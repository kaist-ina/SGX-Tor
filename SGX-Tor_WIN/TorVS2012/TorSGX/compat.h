...
tor_mmap_t *real_tor_mmap_file(const char *filename) ATTR_NONNULL((1));
int real_tor_munmap_file(tor_mmap_t *handle) ATTR_NONNULL((1));
...
int real_tor_open_cloexec(const char *path, int flags, unsigned mode);
sgx_file *tor_fopen_cloexec(const char *path, const char *mode);
int tor_rename(const char *path_old, const char *path_new);
int real_tor_rename(const char *path_old, const char *path_new);

int replace_file(const char *from, const char *to);
int real_replace_file(const char *from, const char *to);
#ifndef TOR_SGX
...
off_t real_tor_fd_getpos(int fd);
int tor_fd_setpos(int fd, off_t pos);
int real_tor_fd_setpos(int fd, off_t pos);
int tor_fd_seekend(int fd);
int real_tor_fd_seekend(int fd);
#ifndef TOR_SGX
int tor_ftruncate(int fd);
#endif // TOR_SGX
int real_tor_ftruncate(int fd);
