...
for i in range(1,4):
	...
	f = open("C:/Users/INA-SGX-USER/Desktop/TorVS2012/nodes/00"+str(i)+"/keys/authority_certificate", 'r')
	while True:
		line = f.readline()
	...
	f = open("C:/Users/INA-SGX-USER/Desktop/TorVS2012/nodes/00"+str(i)+"/fingerprint", 'r')
	line = f.readline()
...
for i in range(1,7):
	newlines = []
	torrc_name = "C:/Users/INA-SGX-USER/Desktop/TorVS2012/nodes/00"+str(i)+"/torrc"
