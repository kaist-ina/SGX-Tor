...
#endif
		//SGX: Remote atteatation server
		if(get_options()->AuthoritativeDir) {
			//printf("Start remote attestation server\n");
			//do_remote_attestatation_server(8001);
		}
    result = do_main_loop();
    break;
  case CMD_KEYGEN:
