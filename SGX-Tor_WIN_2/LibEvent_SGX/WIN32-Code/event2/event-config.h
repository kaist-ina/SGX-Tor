...
//struct protoent;
//extern struct protoent *sgx_getprotobynumber(int number);
...
//extern int sgx_vscprintf(const char *format, va_list v);
...
//extern __uint64_t sgx_beginthread(void (*fn)(void *), int num, void *port, int port_len);
